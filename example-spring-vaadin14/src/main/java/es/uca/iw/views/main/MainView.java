...
import es.uca.iw.views.masterdetail.MasterDetailView;
import es.uca.iw.views.personform.PersonFormView;
import es.uca.iw.views.addressform.AddressFormView;
...
@PWA(name = "IW Project", shortName = "IW Project", enableInstallPrompt = false)
public class MainView extends AppLayout {
    ...
    private HorizontalLayout createHeader() {
        ...
        header.setId("header");
        Image logo = new Image("images/logo.png", "IW Project logo");
        logo.setId("logo");
        header.add(logo);
        Image avatar = new Image("images/user.svg", "Avatar");
        avatar.setId("avatar");
        header.add(new H1("IW Project"));
        header.add(avatar);
        return header;
    }
